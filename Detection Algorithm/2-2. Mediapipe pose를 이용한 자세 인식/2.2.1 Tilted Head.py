...
def headCheck(image_width, image_height, points):
    ...
    """
    # list에 좌표가 있는지 없는지 확인하는 코드
    if not points.landmark[mp_pose.PoseLandmark(32).value].x * image_width:
        print("Nose is not found")
    else:
        print("Nose is found")
    """
...
# cap = cv2.VideoCapture("../Test Image/sample.mp4")
